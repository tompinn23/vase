...
class Config:
    ...
    def __init__(self, filename: str | None = None):
        ...
        self.default_journal_path = known_folder_path(SAVEDGAMES) / "Frontier Developments" / "Elite Dangerous"
    ...
    def get_str(self, key :str, *, table: str | None = None, default: str | None = None) -> str:
